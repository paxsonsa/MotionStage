...
class MotionStageServer:
    def __init__(self, name: str = "motionstage", security: SecurityMode = SecurityMode.TRUSTED_LAN):
        ...
        self._native = (
            _NativeMotionStageServer(name=name) if _NativeMotionStageServer is not None else None
        )
        self._running = False
...
# Backward-compatibility aliases for previous SDK naming.
CineSession = MotionStageSession
CineServer = MotionStageServer
_NativeCineServer = _NativeMotionStageServer
