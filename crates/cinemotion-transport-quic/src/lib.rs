...
use cinemotion_core::{AttributeUpdate, AttributeValue};
use cinemotion_protocol::{ControlMessage, PROTOCOL_MAJOR, PROTOCOL_MINOR};
...
mod tests {
    ...
    use cinemotion_protocol::ControlMessage;
    use uuid::Uuid;
